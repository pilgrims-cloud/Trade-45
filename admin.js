// Global Pilgrim Trader - Enhanced Admin Dashboard JavaScript
...
function loadDashboardStats() {
    ...
    // Update MetaTrader status
    const mtStatus = document.getElementById('metaTraderStatus');
    if (mtStatus) {
        mtStatus.textContent = stats.metaTraderConnected ? 'Connected' : 'Disconnected';
        mtStatus.className = stats.metaTraderConnected ? 'status-connected' : 'status-disconnected';
    }
        ...
        return `
            <div class="trade-card">
                ...
                <div class="trade-details">
                    ...
                    <div class="trade-detail">Signature: <span>${trade.signature.signature.substring(0, 16)}...</span></div>
                    <div class="trade-detail">Signed by: <span>${trade.signature.owner}</span></div>
                </div>
            </div>
        `;
    }).join('');
        ...
        return `
            <div class="payment-card">
                <div class="payment-info">
                    ...
                    <p><i class="fas fa-signature"></i> Signature: ${transaction.signature.signature.substring(0, 16)}...</p>
                    <p><i class="fas fa-user-tie"></i> Signed by: ${transaction.signature.owner}</p>
                </div>
...
// Initialize
console.log('Global Pilgrim Trader Enhanced Admin Dashboard Initialized');
console.log('Owner: Olawale Abdul-Ganiyu');
console.log('Contact: adeganglobal@gmail.com | +2349030277275');
console.log('Features: Transaction Signatures, Real Profit Updates, Enhanced User Management');